...
The --ontop option stops it from running as a daemon, making it easier to see what's happening. In another terminal, run the client with:

    $ chain-reactor-client --address 127.0.0.1 --port 20000
